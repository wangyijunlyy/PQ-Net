...
class EncoderLayer(nn.Module):
    ...
    """
    def __init__(self, attention, d_model, d_ff=None, moving_avg=25, dropout=0.1, activation="relu",exp_setting=0):
        ...
        if exp_setting == 0:
            ...
            self.mlp1 = PQN(input_dim=d_model, output_dim=d_ff)
            self.mlp2 = PQN(input_dim=d_ff, output_dim=d_model)
...
class DecoderLayer(nn.Module):
    ...
    def __init__(self, self_attention, cross_attention, d_model, c_out, d_ff=None,
                 moving_avg=25, dropout=0.1, activation="relu",exp_setting=0):
